...
MASTERS = ROOT / 'outputs/living-world-v2/masters'
DEST = ROOT / 'public/art/living-world-v2'
DEST.mkdir(parents=True, exist_ok=True)
SPECS = {'hero-desktop': [1200, 1584], 'hero-mobile': [768, 1024],
...
(ROOT / 'outputs/living-world-v2/asset-manifest.json').write_text(json.dumps(records, indent=2), encoding='utf-8')
