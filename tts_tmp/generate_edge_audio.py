...
async def main():
 ...
 # copy best short test for optional manual check
 bestn=chosen['rows'][0][0]; src=WORK/f't_{"d8" if voice.endswith("DmitryNeural") and rate=="-8%" else "d16" if voice.endswith("DmitryNeural") else "s12"}_{bestn}.mp3';shutil.copy2(src,RESULT/'контрольный_фрагмент.mp3')
